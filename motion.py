...
class Motion_est:
    ...
    def plotflow(self, I, X, Y, U, V, file1, file2,scale=1, threshold=-1):
        ...
        ax.set_aspect('equal')
        plt.savefig('/data/yzh/seafog_fy4b_37/h8_2020/motion_results/png/'+ file1[:-4]+'.png')
        # plt.show()
        return   
        ...
        for j in range(0, len(U), ws):
            ...
            for k in range(0, len(V[0]), ws):
                try: 
                    ...
                    print(j,k)
            jc+=1
        npysave = '/data/yzh/seafog_fy4b_37/h8_2020/motion_results/npy/'
...
if __name__ == "__main__":
    ...
    path  ='/data/yzh/seafog_fy4b_37/h8_2020/test_png/'
    ...
    for date in dates:
        ...
        for i in range(1, len(files)):
            # for i in range(1):
                ...
                me_class.main(choice_v, path+date+'/', file1, file2)
                print(n, file1)
                n = n+1
                toc = time.time() - tic
